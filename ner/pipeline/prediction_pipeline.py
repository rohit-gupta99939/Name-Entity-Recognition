...
from ner.entity.config_entry import ModelPredictorConfig
    ...
    def initiate_model_predictor(self, sentence: str) -> str:
        ...
        try:
            ...
            logging.info("ids to label Pickle file downloaded from google storage")
             ...
             # Check if model file already exists in the destination folder
            model_file_path = os.path.join(
                self.model_predictor_config.best_model_from_gcp_path, GCP_MODEL_NAME
            )
